...
class ClosedTaskDetailsBody extends StatefulWidget {
  const ClosedTaskDetailsBody({
    super.key,
  });

  @override
  State<ClosedTaskDetailsBody> createState() => _ClosedTaskDetailsBodyState();
}

class _ClosedTaskDetailsBodyState extends State<ClosedTaskDetailsBody> {
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Приглашенные эксперты (${state.task.applicants.length})', style: CwTextStyles.taskHeader),
                      ),
