...
class CreateTaskDialog extends StatefulWidget {
  ...
  const CreateTaskDialog({super.key, required this.userId});
                          ...
                          child: Column(
                            children: [
                              Align(
                                ...
                                child:
                                    Text('Создание нового запроса', style: CwTextStyles.taskHeader.withColor(CwColors.startHeaderPrimary)),
                              ),
                                    ...
                                    itemBuilder: (context, index) => ListTile(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          _subindustryTitle = subindustryItems[index].name;
                                    ...
                                    itemBuilder: (context, index) => ListTile(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          _subfunctionTitle = subfunctionItems[index].name;
                              ...
                              CwCheckbox(
                                ...
                                label: const Wrap(
                                  children: [
                                    Text(
                                      'Общий запрос',
                                      style: TextStyle(decorationColor: CwColors.primaryText, fontSize: 16),
                                    )
                                  ],
                                ),
                              ),
                              ...
                              CwElevatedButton(
                                block: true,
                                text: 'Создать и пригласить эксперта',
                                heightStyle: CwButtonHeightEnum.standard,
                                onTap: isFormReady
                                    ? () => {
                                          BlocProvider.of<TaskBloc>(context).add(
                                            TaskEvent.createInviteTask(
