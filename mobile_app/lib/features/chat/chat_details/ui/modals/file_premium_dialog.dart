...
import 'package:clokwise/features/chat/chat_details/ui/modals/widgets/file_no_premium_widget.dart';
...
class FilePremiumDialog extends StatelessWidget {
  const FilePremiumDialog({super.key});
            ...
            children: [
              BlocBuilder<PaymentBloc, PaymentState>(
                builder: (context, state) => state.maybeMap(
                  ...
                  initial: (_) => const FileNoPremiumWidget(),
