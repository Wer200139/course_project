...
part of 'chat_support_list_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ChatSupportListModel _$ChatSupportListModelFromJson(
        Map<String, dynamic> json) =>
    ChatSupportListModel(
...
Map<String, dynamic> _$ChatSupportListModelToJson(
        ChatSupportListModel instance) =>
    <String, dynamic>{
      'id': instance.id,
