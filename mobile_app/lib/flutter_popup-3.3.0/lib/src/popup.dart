...
class CustomPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTapUp: !isLongPress ? onTap != null ? (_) {
        onTap();
        _show(context);
      } : (_) => _show(context) : null,
      child: child,
    );
  }
}
...
class _PopupRoute extends PopupRoute<void> {
  ...
  Future<RoutePopDisposition> willPop() async {
    onDismissed(); // Call the onDismiss callback
    return RoutePopDisposition.pop; // Return a RoutePopDisposition value
  }
